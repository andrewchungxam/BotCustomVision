...
//namespace LuisAndQandA1.Dialogs.CoordinateCustomerServiceDialog
//{
//    public class CoordinatedComputerVisionOCRandBarcodeDialog
//    {
//    }
//}
...
namespace LuisAndQandA1.Dialogs
{
    ...
    [Serializable]
    public class CoordinatedComputerVisionOCRandBarcodeDialog : IDialog<bool>
    {
        private readonly ICaptionService captionService = new MicrosoftCognitiveCaptionService();
        private int attempts = 3;
        private string itemType = "barcode or serial number.";
